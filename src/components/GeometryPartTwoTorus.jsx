...
const GeometryPartTwoTorus = () => {
  const thisBox = useRef();

  return (
    <>
      <CanvasContainer>
        <Title>Geomeometry Part Two : TorusGeometry</Title>
        <Canvas>
          <Suspense fallback={null}>
            ...
            <group ref={thisBox}>
              <mesh>
                <torusGeometry attach="geometry" args={[2, 0.4, 16, 16]} />
...
export default GeometryPartTwoTorus;
